...
## Project Structure
    ...
    ├── testapiautosettings_91469  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_91469`
...
2. Clone this repo and `cd testapiautosettings_91469`
